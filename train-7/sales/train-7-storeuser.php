...
<div class="content" align="center">
  ...
  <?php
    echo "<tr>";
      ...
      echo  "<td>功能</td>";
      echo  "<td>";
      echo    "<form action='train-7-storeadd.php' method='post' onSubmit='return returnvalue'>";
    ...
    for($i=1;$i<=mysqli_num_rows($saln);$i++){
      ...
      echo "<td>".$salap[1]."</td>";
      echo "<td colspan='2'>";
      echo "<form action='train-7-function.php' method='post' onSubmit='return returnvalue'>";
